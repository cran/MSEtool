...
plot.Catchability(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=1)
```
...
plot.Catchability(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=2)
```
