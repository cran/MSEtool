...
hist2(Pars$Fleet$Esd, col=params$plotPars$col, axes=params$plotPars$axes, main="Esd", breaks=params$plotPars$breaks)
abline(v=Pars$Fleet$Esd[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
axis(side=1) 
