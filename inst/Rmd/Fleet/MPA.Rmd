...
hist2(Pars$Fleet$Spat_targ, col=params$plotPars$col, axes=params$plotPars$axes, main="Spat_targ", breaks=params$plotPars$breaks)
abline(v=Pars$Fleet$Spat_targ[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
axis(side=1) 
