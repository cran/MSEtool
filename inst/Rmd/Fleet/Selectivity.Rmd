...
plot.Selectivity(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=1)
...
plot.Selectivity(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=2) 
```

#### Selectivity & Retention at Length

```{r SR_at_length, echo=FALSE}
plot.Selectivity(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=3)

```

#### Selectivity & Retention at Age
```{r SR_at_age, echo=FALSE}
plot.Selectivity(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=4)
```
