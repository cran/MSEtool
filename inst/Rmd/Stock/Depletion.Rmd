...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist2(Pars$Stock$D, col=params$plotPars$col, axes=params$plotPars$axes, main="Depletion (D)", breaks=params$plotPars$breaks)
abline(v=Pars$Stock$D[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
axis(side=1) 

hist2(Pars$Stock$Fdisc, col=params$plotPars$col, axes=params$plotPars$axes, main="Fdisc", breaks=params$plotPars$breaks)
abline(v=Pars$Stock$Fdisc[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
axis(side=1)
```
