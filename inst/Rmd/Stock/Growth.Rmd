...
```{r, echo=FALSE}
plot.Growth(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=1)
```
...
```{r, echo=FALSE}
plot.Growth(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=2)
```
...
```{r, echo=FALSE}
 plot.Growth(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=3)
```
