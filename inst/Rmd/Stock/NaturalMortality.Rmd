...
```{r, echo=FALSE}
plot.NaturalMortality(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=1)
```
...
```{r, echo=FALSE}
plot.NaturalMortality(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=2)
```
...
```{r, echo=FALSE}
plot.NaturalMortality(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=3)
```
...
```{r, echo=FALSE}
plot.NaturalMortality(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=4)
```
