...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist2(Pars$Stock$M, main="M", col=params$plotPars$col, axes=params$plotPars$axes,
      breaks=params$plotPars$breaks, cex.main=params$plotPars$cex.main)
abline(v=Pars$Stock$M[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
axis(side=1) 

# hist2(Pars$Stock$Mexp, main="Mexp", col=params$plotPars$col, axes=params$plotPars$axes,
#       breaks=params$plotPars$breaks, cex.main=params$plotPars$cex.main)
# abline(v=Pars$Mexp[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
# axis(side=1) 

hist2(Pars$Stock$Msd, main="Msd", col=params$plotPars$col, axes=params$plotPars$axes,
      breaks=params$plotPars$breaks, cex.main=params$plotPars$cex.main)
abline(v=Pars$Stock$Msd[params$its], col=1:nsamp, lwd=params$plotPars$lwd)
axis(side=1) 
```
...
matplot(years, t(Pars$Stock$Marray[params$its,]), type="l", lty=1, bty="l", main="M by Year", 
...
par(mfrow=c(1,3))
lims <- range(Pars$Stock$M_ageArray[params$its,, ])
ylab <- "Natural Mortality"
matplot(0:maxage, t(Pars$Stock$M_ageArray[params$its,,1]), type="l", lty=1, bty="l", 
...
matplot(0:maxage, t(Pars$Stock$M_ageArray[params$its,,nyears]), type="l", lty=1, bty="l", 
        main="M-at-age", lwd=params$plotPars$lwd, ylim=lims, axes=FALSE,
        ylab="")
mtext(side=3, "Last historical year", cex=0.8, line=-1)
axis(side=1)
mtext(side=1, "Age", line=2, cex=0.7)
matplot(0:maxage, t(Pars$Stock$M_ageArray[params$its,,nyears+proyears]), type="l", lty=1, 
...
par(mfrow=c(1,3))
lims <- range(Pars$Stock$M_ageArray[params$its,, ])
xlims <- range(Pars$Stock$Len_age[params$its,,])
matplot(t(Pars$Stock$Len_age[params$its,,1]), t(Pars$Stock$M_ageArray[params$its,,1]), type="l", 
        lty=1, bty="l", lwd=params$plotPars$lwd, ylim=lims, xlim=xlims, ylab="Natural Mortality", 
        xlab="", las=1)
mtext(side=3, "First historical year", cex=0.8, line=-1)
mtext(side=1, "Length", line=2, cex=0.7)
  
matplot(t(Pars$Stock$Len_age[params$its,,nyears]), t(Pars$Stock$M_ageArray[params$its,,nyears]), 
...
matplot(t(Pars$Stock$Len_age[params$its,,nyears+proyears]), 
        t(Pars$Stock$M_ageArray[params$its,,nyears+proyears]), 
