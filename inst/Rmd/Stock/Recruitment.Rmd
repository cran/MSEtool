...
```{r, echo=FALSE}
plot.Recruitment(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=1)
```

#### Time-Series

```{r, echo=FALSE}
plot.Recruitment(params$Pars, nsamp=nsamp, plotPars=params$plotPars, plot.num=2)
```
